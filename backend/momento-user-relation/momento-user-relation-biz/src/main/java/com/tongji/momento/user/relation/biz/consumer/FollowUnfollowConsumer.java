package com.tongji.momento.user.relation.biz.consumer;
...
import com.tongji.momento.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.tongji.momento.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "momento_group_" + MQConstants.TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
