package com.tongji.momento.user.biz.service.impl;
...
import com.tongji.momento.user.biz.constant.RedisKeyConstants;
import com.tongji.momento.user.biz.constant.RoleConstants;
import com.tongji.momento.user.biz.domain.dataobject.RoleDO;
import com.tongji.momento.user.biz.domain.dataobject.UserDO;
import com.tongji.momento.user.biz.domain.dataobject.UserRoleDO;
import com.tongji.momento.user.biz.domain.mapper.RoleDOMapper;
import com.tongji.momento.user.biz.domain.mapper.UserDOMapper;
import com.tongji.momento.user.biz.domain.mapper.UserRoleDOMapper;
import com.tongji.momento.user.biz.enums.ResponseCodeEnum;
import com.tongji.momento.user.biz.enums.SexEnum;
import com.tongji.momento.user.biz.model.vo.UpdateUserInfoReqVO;
import com.tongji.momento.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.tongji.momento.user.biz.rpc.OssRpcService;
import com.tongji.momento.user.biz.service.UserService;
import com.tongji.momento.user.dto.req.*;
import com.tongji.momento.user.dto.resp.FindUserByEmailRspDTO;
import com.tongji.momento.user.dto.resp.FindUserByIdRspDTO;
import com.tongji.momento.user.dto.resp.FindUserByNicknameRspDTO;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        // 小哈书号
        String momentoId = updateUserInfoReqVO.getMomentoId();
        if (StringUtils.isNotBlank(momentoId)) {
            Preconditions.checkArgument(ParamUtils.checkMomentoId(momentoId), ResponseCodeEnum.MOMENTO_ID_VALID_FAIL.getErrorMessage());
            userDO.setMomentoId(momentoId);
            needUpdate = true;
        }
    ...
    public Response<Long> register(RegisterUserReqDTO registerUserReqDTO) {
        ...
        String momentoId = distributedIdGeneratorRpcService.getMomentoId();
        ...
        UserDO userDO = UserDO.builder()
                .id(userId)
                .email(email)
                .momentoId(momentoId) // 自动生成小红书号 ID
