...
import com.tongji.momento.count.biz.enums.FollowUnfollowTypeEnum;
import com.tongji.momento.count.biz.model.dto.CountFollowUnfollowMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "momento_group_" + MQConstants.TOPIC_COUNT_FOLLOWING_2_DB, // Group 组
